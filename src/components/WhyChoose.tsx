...
export default function WhyChoose({ theme }: WhyChooseProps) {
  const features = [
    { icon: Layers, title: "Premium Fabrics", desc: "Egyptian cottons, premium English cashmeres, Japanese satins, and pure silk lines that breathe beautifully and drop perfectly." },
    { icon: Scissors, title: "Exceptional Craftsmanship", desc: "Every cut, stitch, and lining is masterfully calibrated to your measurements, delivering zero bunching and pristine symmetry." },
    { icon: Globe, title: "Authentic Nigerian Fashion", desc: "Preserving cultural depth with rich, traditional royal wear—Agbada, Senator, and hand-selected vibrant Ankara materials." },
    { icon: Briefcase, title: "Modern Corporate Styles", desc: "Tailored executive power suits, structured jackets, and high-performance corporate wear crafted to inspire heavy board presence." },
    { icon: Truck, title: "Fast Delivery", desc: "Reliable custom shipping logistics with secured door-to-door nationwide delivery tracking across all 36 Nigerian states." },
